<?php
	$adresa="9904 South Roberts Road Palos Hills, IL 60465"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=7085983805;// Broj koji se poziva na dugme CALL US
